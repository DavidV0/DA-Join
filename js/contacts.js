                    ...
                    <div> 
                        <form onsubmit="saveNewContactInformation(${i}); return false">
                            <div class="contact-input-fields">
                                ...
                                <input type="tel" required placeholder="Phone" pattern="[0-9]+" title="Please enter only digits" id="edit-phone-number">
                            </div>
  ...
  for (let key in sortedData) {
    ...
    document.getElementById("contacts-overview").innerHTML += /*html*/ `
        <div class="contact-container" id="contact-container">
            <span> ${letter} </span>
            <img src="../assets/img/contact/Vector 10.svg">
    ...
    document.getElementById(
      `contact-elements-${letter}`
            ...
            <div class="contact-names">
                ...
                <a href="mailto:${contactsInLetters[i]["email"]}">${contactsInLetters[i]["email"]}</a>
            </div>
        </div>    
        `;
  }
